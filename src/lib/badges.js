/* Catálogo de conquistas/selos do trabalhador.
   Cada badge tem:
   - tier: 'gold' | 'silver' | 'bronze' (cor da medalha)
   - symbol: caractere unicode discreto no centro da medalha
   - emoji: usado em contextos onde a medalha não é renderizada
   - check(stats): se foi conquistado pelas estatisticas
*/

export const BADGES = [
  { id: 'first_claim',
    tier: 'bronze', symbol: '✿', emoji: '🌱',
  ...
  { id: 'top_3',
    tier: 'gold', symbol: '♛', emoji: '👑',
    nome: 'Top 3 da Fazenda',
